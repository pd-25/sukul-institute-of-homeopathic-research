        ...
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                <div class="ctn-right-box">
                    ...
                    <a href="{{route('frontend.research')}}" class="rm-btn-red">Read More <i class="fa fa-angle-double-right"
        ...
        <div class="row">
            <div class="col-lg-6 align-self-center">
                <div class="ctn-left-box">
                    ...
                    <a href="{{route('frontend.course')}}" class="rm-btn-red">Read More <i class="fa fa-angle-double-right"
                            aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-lg-6 p-0">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 align-self-center">
                ...
                <a href="{{route('frontend.cancerTherapy')}}" class="rm-btn-red">Read More <i class="fa fa-angle-double-right"
                        aria-hidden="true"></i></a>
            </div>
                    ...
                    <div id="owl-journal" class="owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="row journal-box">
                                <div class="col-lg-5">
                                    <img src="{{asset("storage/". $item->image)}}" class="img-fluid w-100" alt="...">
                                </div>
                                <div class="col-lg-7 align-self-center">
                                    <h3>{{ $item->title }}</h3>
                                    <p class="jdate"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                                        <b>Published :</b> {{ \Carbon\Carbon::parse($item->created_at)->format('jS F, Y') }}</p>
                                    <p>{{ Str::limit(strip_tags($item->description), 450, '...') }}</p>
                                    <a href="{{ route('frontend.singlejurnal', ['slug' => $item->slug]) }}" class="rm-btn-red mt-2">Read More <i
